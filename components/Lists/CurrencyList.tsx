		...
		<tbody className='bg-white divide-y divide-gray-200'>
			<tr key={currency.id}>
				...
				<td className='px-6 py-4 whitespace-nowrap '>
					<div className='flex'>
						{currency.price_change_24h < 0 ? (
							<svg className='h-4 w-4 text-red-500 ' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg' stroke='#ff0000' stroke-width='2'>
								<path d='M6 9l6 6 6-6' />
							</svg>
						) : (
							<svg className='h-4 w-4 text-green-500 ' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg' stroke='#00d600' stroke-width='2'>
				...
				<td className='px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-right'>
					<CurrencyFormat value={currency.circulating_supply} displayType={'text'} thousandSeparator={true} />
